...
#define KEY_DN_GPIO_CLK_EN __GPIOC_CLK_ENABLE
#define KEY_DN_GPIO        GPIOC
#define KEY_DN_GPIO_PIN    GPIO_PIN_12

#define KEY_ET_GPIO_CLK_EN __GPIOB_CLK_ENABLE
#define KEY_ET_GPIO        GPIOB
#define KEY_ET_GPIO_PIN    GPIO_PIN_12

#define KEY_BK_GPIO_CLK_EN __GPIOC_CLK_ENABLE
#define KEY_BK_GPIO        GPIOC
#define KEY_BK_GPIO_PIN    GPIO_PIN_13
